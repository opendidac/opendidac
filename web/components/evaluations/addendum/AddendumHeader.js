        ...
        {addendum ? (
          ...
          <Stack direction="row" alignItems="center" spacing={1}>
            ...
            <UserHelpPopper label="What is an addendum?">
              <Typography>
                An addendum is a post-grading note that provides students with additional information about the solution for this question.  
              </Typography>
              <Typography>
                It serves as a shared clarification or explanation, helping students understand common mistakes, grading criteria, or key takeaways from the assessment.
              </Typography>
              <Typography>
                Since the same addendum is visible to all students, it acts as collective feedback rather than individual comments.
              </Typography>
            </UserHelpPopper>
